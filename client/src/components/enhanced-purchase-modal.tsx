...
export function EnhancedPurchaseModal({ isOpen, onClose, game, seatNumbers, totalPrice }: EnhancedPurchaseModalProps) {
          ...
          <>
            ...
            <div className="space-y-6">
              ...
              <div className="flex space-x-3">
                ...
                <Button onClick={handlePurchase} className="flex-1 seatwell-primary">
