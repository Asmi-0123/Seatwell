// Editable content configuration for Seatwell
...
Founded with the vision of making sports more accessible, we believe every fan deserves a chance to support their team, even when games are sold out.`
  ...
  sellTicket: {
    expectedPayoutText: "Based on 75% of average resale price - this percentage may vary depending on demand and game popularity",
    bankInfoExplanation: {
